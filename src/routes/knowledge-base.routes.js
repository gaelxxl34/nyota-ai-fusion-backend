...
router.delete("/:id", checkRole(["superAdmin", "admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.put("/", checkRole(["superAdmin", "admin"]), async (req, res) => {
  try {
...
// Get backup files
router.get("/backups", checkRole(["superAdmin", "admin"]), async (req, res) => {
  try {
